        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodigoEstado = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdArchivo = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CICliente = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArchivosCliente_FechaSubida",
                table: "ArchivosCliente",
                column: "FechaSubida");

            migrationBuilder.CreateIndex(
                name: "IX_Clientes_FechaRegistro",
                table: "Clientes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LogsApi_CodigoEstado",
                table: "LogsApi",
                column: "CodigoEstado");

            migrationBuilder.CreateIndex(
                name: "IX_LogsApi_DateTime",
                table: "LogsApi",
                column: "DateTime",
                descending: new bool[0]);

            migrationBuilder.CreateIndex(
                name: "IX_LogsApi_TipoLog",
                table: "LogsApi",
                column: "TipoLog");
        }
